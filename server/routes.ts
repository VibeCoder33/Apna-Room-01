...
import { insertListingSchema, insertApplicationSchema, insertMessageSchema, insertReviewSchema } from "@shared/schema";
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get('/api/applications/sent', isAuthenticated, async (req: any, res) => {
    try {
      const userId = req.user.claims.sub;
  ...
  app.get('/api/applications/received', isAuthenticated, async (req: any, res) => {
    try {
      const userId = req.user.claims.sub;
  ...
  // Message routes
  app.get('/api/messages/:chatId', isAuthenticated, async (req: any, res) => {
    try {
      const userId = req.user.claims.sub;
